    ...
    return ( 
        <div className="absolute z-10 flex items-center justify-between w-full px-16 py-3 top-2 ">
            ...
            <div id="search" className="relative flex items-center max-w-lg w-100 grow">
                ...
                <input type="text" onChange={(e) => setSearchKey(e.target.value)} className={`px-3 placeholder-white bg-transparent border-2 ${borderClass} rounded-md h-9 grow`} placeholder="What do you want to watch?"/>
